        ...
        <div className="App">
            <form onSubmit={handleSubmit(onSubmit)}>
                <div>
                    ...
                    <input data-testid="firstName" name="firstName" placeholder="bill" ref={register({ required: true, maxLength: 3 })} />
                    {errors.firstName && (
                ...
                <div>
                    ...
                    <input data-testid="lastName" name="lastName" placeholder="luo" ref={register({ required: true })} />
                    {errors.lastName && (
